...
export default function Information() {
  ...
  return (
    <div>
      <main className="flex-1 p-4 flex flex-col text-center gap-3 sm: gap-4 md: gap-5 justify-center items-center h-screen pb-20 w-fit max-w-prose w-full mx-auto">
