...
export default function Transcribing(props) {
  ...
  return (
    <div className="flex items-center flex-col text-center justify-center gap-10 md: gap-14 pb-24 p-4 flex-1">
      <div className="flex flex-col gap-2 sm:gap-4">
        <h1 className="font-semibold text-4xl sm:text-5xl md:text-6xl">
          <span className="text-blue-400 bold">Transcribing</span>
        </h1>
        <p>
          {!downloading ? "mr robot is transcribing" : "mr robot has finished"}
        </p>
      </div>
